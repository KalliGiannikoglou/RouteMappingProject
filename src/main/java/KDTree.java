...
public class KDTree {
     ...
     * size method to a check of whether the root node is null.
     *
    ...
    public void insert(Point2D p) {
        ...
        root = insert(root, p, true, new double[] {0, 0, 50, 50});
    }
